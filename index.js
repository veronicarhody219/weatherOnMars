const API_KEY = "c6oFgCVjMpyUgEv8FAU9knVVJngA1bU3ZcvqPzqi";
...
function displaySeclectedSol(sols) {
...
function displaySpeed(speed) {
  ...
  if(!isMetric()){returnSpeed=speed/1.60934;}
  return Math.round(returnSpeed);
}

// display previous weather
